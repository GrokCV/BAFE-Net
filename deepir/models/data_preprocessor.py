...
from deepir.utils import stack_dual_seg_batch


@MODELS.register_module()
class DualSegDataPreProcessor(BaseDataPreprocessor):
    ...
    def forward(self, data: dict, training: bool = False) -> Dict[str, Any]:
        ...
        if training:
            ...
            inputs, data_samples = stack_dual_seg_batch(
                inputs=inputs,
            ...
            if self.test_cfg:
                inputs, padded_samples = stack_dual_seg_batch(
                    inputs=inputs,
