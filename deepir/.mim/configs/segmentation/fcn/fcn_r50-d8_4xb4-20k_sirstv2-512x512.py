...
CUDA_VISIBLE_DEVICES=0 python tools/train_seg.py configs/fcn/fcn_r50-d8_4xb4-20k_sirstv2-512x512.py

Test Script:

python tools/test_seg.py configs/fcn/fcn_r50-d8_4xb4-20k_sirstv2-512x512.py \
    work_dirs/fcn_r50-d8_4xb4-20k_sirstv2-512x512/iter_20000.pth \
    --show-dir work_dirs/fcn_r50-d8_4xb4-20k_sirstv2-512x512/show
"""
