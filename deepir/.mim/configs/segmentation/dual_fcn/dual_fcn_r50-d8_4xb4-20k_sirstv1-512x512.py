...
CUDA_VISIBLE_DEVICES=1 python tools/train_seg.py configs/dual_fcn/dual_fcn_r50-d8_4xb4-20k_sirstv1-512x512.py

Test Script:

python tools/test_seg.py configs/dual_fcn/dual_fcn_r50-d8_4xb4-20k_sirstv1-512x512.py \
    work_dirs/dual_fcn_r50-d8_4xb4-20k_sirstv1-512x512/iter_14000.pth \
    --show-dir work_dirs/dual_fcn_r50-d8_4xb4-20k_sirstv1-512x512/show
"""
