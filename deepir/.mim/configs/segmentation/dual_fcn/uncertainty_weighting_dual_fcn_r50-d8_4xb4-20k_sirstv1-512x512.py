...
python tools/train_seg.py configs/dual_fcn/uncertainty_weighting_dual_fcn_r50-d8_4xb4-20k_sirstv1-512x512.py
...
_base_ = [
    '../_base_/models/uncertainty_weighting_dual_fcn_r50-d8.py',
