...
CUDA_VISIBLE_DEVICES=2 python tools/train_seg.py configs/modulated_dual_fcn/uncertainty_weighting_modulated_dual_fcn_r50-d8_4xb4-20k_sirstv1-512x512.py

Test Script:
"""

_base_ = [
    '../_base_/models/uncertainty_weighting_modulated_dual_fcn_r50-d8.py',
