...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 python tools/train_det.py configs/detection/fcos_modulated_seg/fcos_modulated_seg_r18-caffe_fpn_gn-head_1x_sirstv2.py
...
model = dict(
    ...
    bbox_head=dict(
        type='deepir.FCOSModulatedSegHead',
