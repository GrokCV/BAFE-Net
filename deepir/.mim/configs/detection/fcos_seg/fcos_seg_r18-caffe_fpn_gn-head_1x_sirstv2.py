...
CUDA_VISIBLE_DEVICES=2 python tools/train_det.py configs/detection/fcos_seg/fcos_seg_r18-caffe_fpn_gn-head_1x_sirstv2.py
...
model = dict(
    ...
    bbox_head=dict(
        ...
        #     loss_weight=1.0)
        loss_seg=dict(
            type="CrossEntropyLoss", use_sigmoid=True, loss_weight=1.0, ignore_index=255
        ),
    ),
    # testing settings
    test_cfg=dict(
