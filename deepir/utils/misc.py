...
def stack_dual_seg_batch(inputs: List[torch.Tensor],
    ...
    Args:
        ...
        data_samples (list[:obj:`SegDataSample`]): The list of data samples.
            It usually includes information such as `gt_sem_seg`, `gt_bg_map`.
    ...
    for i in range(len(inputs)):
        ...
        if data_samples is not None:
            ...
            if 'gt_bg_map' in data_sample:
                gt_bg_map = data_sample.gt_bg_map.data
                del data_sample.gt_bg_map.data
                data_sample.gt_bg_map.data = F.pad(
                    gt_bg_map, padding_size, value=seg_pad_val)
