'''
CUDA_VISIBLE_DEVICES=2 python tools/analysis_tools/get_flops.py work_dirs/fcos_changer_seg_r18-caffe_fpn_gn-head_1x_sirstv2/mAP12/mAP12-resnet18-0233-0341/vis_data/config.py
'''
...
def main():
    ...
    # Save the results to flops.txt in the same directory as the config file
    output_file = Path(args.config).parent.parent / 'flops.txt'
